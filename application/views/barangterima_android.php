              ...
              <table class="table">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="<?= base_url('android/edit_barangterima/'.$barangterima['id'])?>"><i class="icon_pencil"></i></a>
                        <a class="btn btn-danger" href="<?= base_url('android/delete_barangterima/'.$barangterima['id'])?>"><i class="icon_close"></i></a>
                    </div>
                    </td>
                  </tr>
                <?php
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="POST" enctype="multipart/form-data" action="<?= base_url('android/create_barangterima'); ?>">
